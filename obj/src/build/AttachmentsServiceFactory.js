...
class AttachmentsServiceFactory extends pip_services_components_node_1.Factory {
    constructor() {
        super();
...
AttachmentsServiceFactory.Descriptor = new pip_services_commons_node_1.Descriptor("pip-services-attachments", "factory", "default", "default", "1.0");
AttachmentsServiceFactory.MemoryPersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-attachments", "persistence", "memory", "*", "1.0");
AttachmentsServiceFactory.FilePersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-attachments", "persistence", "file", "*", "1.0");
AttachmentsServiceFactory.MongoDbPersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-attachments", "persistence", "mongodb", "*", "1.0");
AttachmentsServiceFactory.ControllerDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-attachments", "controller", "default", "*", "1.0");
AttachmentsServiceFactory.SenecaServiceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-attachments", "service", "seneca", "*", "1.0");
AttachmentsServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-attachments", "service", "http", "*", "1.0");
